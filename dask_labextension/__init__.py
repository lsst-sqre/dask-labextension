...
def load_jupyter_server_extension(nb_server_app):
    ...
    get_cluster_path = url_path_join(
        base_url, "dask/clusters/" + cluster_id_regex)
    ...
    logging.warning("get_cluster_path: {}".format(get_cluster_path))
    logging.warning("list_clusters_path: {}".format(list_clusters_path))
    logging.warning("get_dashboard_path: {}".format(get_dashboard_path))
